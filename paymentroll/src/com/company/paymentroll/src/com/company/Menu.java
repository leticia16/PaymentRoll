...
//        System.out.print("_____________\n");
    ...
    public void cardPoint(ArrayList<Employee> hourlyEmployees){
...
//                    System.out.println(hourlyAux.toString());
        ...
        //Check if total time working is less than 8 or not.
        /*System.out.printf("\nEntry : %d", entry);
        System.out.printf("\nExit : %d", exit);*/
        System.out.printf("\ntime of Permanence : %d\n", (exit - entry)/60);
        // CREATE HOURLY OBJECT
        Hourly hourlyEmployee = new Hourly(hourlyAux,entry,exit);
